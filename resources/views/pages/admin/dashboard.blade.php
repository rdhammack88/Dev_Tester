...
<div class="container-fluid"> --}} {{--
    ...
    </div> --}} {{-- @if (count($questions) > 0) @foreach ($questions as $question)
    <p>{{ $question }}</p>
    @endforeach @else
    <p>You have not created any questions</p>
    @endif --}} {{-- {{ $user_id }} --}} {{-- {{ $questions }} --}}
    ...
    <main id="adminPage" class="container-fluid">
            ...
            <div class="col-md-3 col-md-offset-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <p class="user-question-count">{{ count($total_user_questions) }} Questions</p>
        ...
        </div> --}} @if (count($questions)) @foreach ($questions as $question)
        ...
        @endforeach {{-- {{ $questions->links() }} --}}
        <div class="container">
            {{ $questions->links() }}
        </div>
        @else
        <h4 class="no-user-questions">You have not added any questions.</h4>
        @endif @elseif (auth()->user()->user_privilege
        <=2 ) <h3 class="no-user-privilege">You have not been approved to add any questions just yet. Please be patient...</h3>
